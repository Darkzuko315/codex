...
const projects = [
  ...
  },
  {
    ...
    description:
      "A modern saloon website with smooth animations and responsive design.",
...

  {
    ...
    description:
      "A trading dashboard that displays real time trading data for multiple cryptocurrencies.",
    ...
    <section id="projects" className="py-24 w-full">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">Codex Projects</h2>
          <div className="h-1 w-20 bg-primary mx-auto rounded-full"></div>
          <p className="mt-4 text-muted-foreground max-w-2xl mx-auto">
            Here are some of our recent projects. Each project showcases
            different skills and technologies from our stack.
          </p>
        </div>
